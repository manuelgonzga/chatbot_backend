...
words = [] # Guardará todas las palabras de todos los patrones
classes = [] # Guarda diferentes intenciones
documents = [] # Guarda tuplas, listas de palabras con su intencion
ignore_letters = ['?','!','.',',']
...
model.fit(np.array(train_x), np.array(train_y), epochs=10000, batch_size=5, verbose=1)
